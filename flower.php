...
<head>
    ...
    <title>Flowers - FlowerShop</title>
    ...
    <div class="pro-container">
        ...
        <div class="pro">
            ...
            <div class="des">
                ...
                <button class="btn-add-to-cart" data-product-id="drops"></button>
            </div>
        </div>
        ...
        <div class="pro">
            ...
            <div class="des">
                ...
                <button class="btn-add-to-cart" data-product-id="felicity"></button>
            </div>
        </div>
        ...
        <div class="pro">
            ...
            <div class="des">
                ...
                <button class="btn-add-to-cart" data-product-id="warm"></button>
            </div>
        </div>
